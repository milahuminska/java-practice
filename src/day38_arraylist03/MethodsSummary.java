...
public static void main(String[] args) {
	...
	//remove method --> using index. removes all values from index position
...
//ADDALL --> adds all values from one list into another
	...
	System.out.println("equals: "+list2.equals(list2));
	...
	list1.clear();
	list2.clear();
	System.out.println("both emty? -"+ (list1.isEmpty() && list2.isEmpty()));
