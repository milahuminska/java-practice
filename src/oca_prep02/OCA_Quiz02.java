...
//		}
		...
		// double, long , float, boolean not accept in switch
		 ...
		 */
		//default: byte=0, short=0, int =0, long =0, double=0.0, float =0.0, boolean =fals, char = empty,
		//String = null; of all Wrapper classes =null;
