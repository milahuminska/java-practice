...
public class Burger7 {
	public static void main(String[] args) {
		...
		String[] ings = { "onion crisps", "american cheese", "pickles", "lettuce", "b7 sause" };
		...
		System.out.println(burger1.ingredients[1]);
		System.out.println(burger1.ingredients[2]);
		System.out.println(burger1.ingredients[3]);
